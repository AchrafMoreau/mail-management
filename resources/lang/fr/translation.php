...
return [
    ...
    "entrantMails" => "les courriers entrants",
    "viewEntantMails" => "voir les courriers entrants",
    "sortantMails" => "les courriers sortants",
    "viewSortantMails" => "voir les Courriers Sortants",
    ...
    "choose" => "Veuillez selectionner un Emetteur",
    "action" => "Action",
    "documents" => "Documents",
